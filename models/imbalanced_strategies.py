...
def test_imbalance_strategies():
    """Teste toutes les stratégies sur données simulées"""
...
if __name__ == "__main__":
    test_imbalance_strategies()

    print("\n" + "=" * 60)
    print("Stratégies pour dataset déséquilibré (7% positifs):")
    print("\n1. 🎯 BalancedPatientSampler : Oversample positifs intelligemment")
    print("2. 📉 AdaptiveFocalLoss : Pénalise hard examples + classe rare")
    print("3. 🔄 CombinedLoss : Focal + AUC optimization")
    print("4. 🎭 MixupAugmentation : Mixup ciblé positifs-négatifs")
    print("5. ⛏️  HardNegativeMiner : Focus sur faux positifs")
    print("6. 📊 ThresholdOptimizer : Trouve meilleur seuil post-training")
    print("7. 🎮 ImbalanceStrategyManager : Coordonne toutes les stratégies")